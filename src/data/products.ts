...
export const products: Product[] = [
  ...
  { id: 6, name: "Rosewood  – Long Almond", price: 11.99, rating: 4, reviews: 12, sizes: ["Long Almond"], colors: ["#c0736a"], description: "Vibrant rosewood chrome in long almond shape.", category: "Press-On Nails", image: "/shape-long-almond.png", images: ["/shape-long-almond.png"], inStock: false },
